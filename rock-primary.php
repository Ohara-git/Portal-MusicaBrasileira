...
<php lang="pt-BR">
    ...
    <body >
        <div class="container bgrock">
            ...
            <div class="row">
                ...
                <section class="col-lg-8 col-md-6 col-sm-12">
                    ...
                    <p> Etiam tortor nunc, vestibulum vel tincidunt eget, pulvinar vitae metus. Etiam sodales dolor nec
                        ...
                        Pellentesque
                        sed turpis pellentesque, vestibulum leo quis, egestas ex. Donec fermentum pellentesque pulvinar.
                        Aenean sed mauris ac ante molestie sagittis. </p>
                </section>
            </div>
            ...
            <div class="row">
                <h1 class="col-lg-12 col-md-12 col-sm-12">Radios</h1>

                <section class="col-lg-6 col-md-12 col-sm-12">
                    <img src="images/89fm.jpg" width="100%" class="img-fluid" />
                    <p> oi Etiam tortor nunc, vestibulum vel tincidunt eget, pulvinar vitae metus. Etiam sodales dolor
                        nec
                        vestibulum consequat. Praesent in metus congue, elementum velit sed, consequat purus. Nunc neque
                        ante, luctus in hendrerit quis, venenatis varius nunc. Aliquam fermentum turpis in consectetur
                ...
                <section class="col-lg-6 col-md-12 col-sm-12">
                    <div class="row">
                        <img src="images/kiss-banner2.jpg"
            ...
            <div class="row">
                <section class="col-lg-12 col-md-12 col-sm-12 btcenter">
                    <button type="button" class="btn btn-secondary"><a href="rock-secondary.php">Veja mais</a></button>
                </section>
            </div>
